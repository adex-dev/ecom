...
require('admin/module/update-profile.php');
...
?>
	...
	<section>
		<div class="box">
			...
			<form method="post" action="dasboard" enctype="multipart/form-data">
				<input type="file" name="image"><br>
				<input type="submit" name="submit1" value="update profile">
			</form>
				</div>
			</div>
		</div>
